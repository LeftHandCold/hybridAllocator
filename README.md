...
| 测试阶段 | 内存使用 | 平均速度         | 磁盘使用率 | 运行时间 |
|---------|---------|--------------|-----------|------|
| 初始阶段(0-10TB) | 133-242 MB | 2.7-2.8 TB/s | 95.50-96.15% | 约13s |
| 中期阶段(10-50TB) | 242-269 MB | 2.7 TB/s     | 95.49-95.57% | 约14s |
| 后期阶段(50-100TB) | 269-300 MB | 2.6-2.7 TB/s | 95.46-95.50% | 约15s |
