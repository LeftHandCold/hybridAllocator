...
| 指标 | basic            | rpc  |
|------|------------------|------|
| 总分配次数 | 813,979          | 819459 |
| 内存池命中 | 114,743 (14.10%) | (14.19%) |
| 内存池未命中 | 699,236 (85.90%) | (85.81%) |
| 总释放次数 | 348,209 (22.28%) | 353108 |
| 释放命中 | 77,565 (22.28%)  | 79101 (22.40%) |
| 释放未命中 | 270,644 (77.72%) | 274007 (77.60%) |
...
| 测试规模 | 阶段             | 总写入量 | 内存使用 | 平均速度   | 持续时间 |
|----------|----------------|---------|----------|--------|----------|
| 10TB | 初始阶段(0-1TB)    | 112 MB | 34,514 MB/s | 22.70s |
| 10TB | 中期阶段(1-5TB)    | 105 MB | 21,375 MB/s | 4m21s  |
| 10TB | 后期阶段(5-10TB)   | 136 MB | 18,743 MB/s | 5m15s  |
| 100TB | 初始阶段(0-10TB)   | 80 MB | 47,019 MB/s | 9m15s  |
| 100TB | 中期阶段(10-50TB)  |  92 MB | 22,804 MB/s | 48m12s |
| 100TB | 后期阶段(50-100TB) | 106 MB | 19,415 MB/s | 59m08s |
