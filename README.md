...
| 测试规模 | 阶段              | 内存使用 | 平均速度   |
|----------|---------|----------|--------|
| 10TB | 初始阶段(0-1TB)    | 124 MB | 1,024,241 MB/s |
| 10TB | 中期阶段(1-5TB)    | 130 MB | 762,450 MB/s | 
| 10TB | 后期阶段(5-10TB)   | 167 MB | 729,973 MB/s |
| 100TB | 初始阶段(0-10TB)   | 158 MB | 1,082,832 MB/s | 
| 100TB | 中期阶段(10-50TB)  | 132 MB | 735,669 MB/s | 
| 100TB | 后期阶段(50-100TB) | 173 MB | 689,736 MB/s |
