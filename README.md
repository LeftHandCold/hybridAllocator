...
|---------|----------|----------|-----------|-------|
| 初始阶段(0-1TB) | 53 MB    | 3.9 TB/s | 96.16% | 240ms |
| 中期阶段(1-5TB) | 54-70 MB | 4-5 TB/s | 95.91-96.04% | 约850ms |
| 后期阶段(5-10TB) | 62-68MB  | 5 TB/s   | 95.50-95.57% | 约910ms |
...
| 测试阶段 | 内存使用       | 平均速度       | 磁盘使用率 | 运行时间 |
|---------|------------|------------|-----------|------|
| 初始阶段(0-10TB) | 60-100 MB  | 4-5。2 TB/s | 95.50-96.15% | 约2s  |
| 中期阶段(10-50TB) | 80-110 MB  | 5。2 TB/s   | 95.49-95.57% | 约8s  |
| 后期阶段(50-100TB) | 269-118 MB | 5。2 TB/s   | 95.46-95.50% | 约10s |
